...
if __name__ == '__main__':
    ...
    detector = SCRFD(model_file=args.model)
    detector.prepare(-1)
    ...
    for img_path in tqdm(img_paths):
        ...
        bboxes, kpss = detector.detect(img, args.thresh, input_size = (640, 640))


        output[img_path] = [bboxes.tolist(), kpss.tolist()]
        if args.draw:
